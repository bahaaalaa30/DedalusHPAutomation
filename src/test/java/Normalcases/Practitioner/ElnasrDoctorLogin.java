...
public class ElnasrDoctorLogin extends BaseTest {
    ...
    public void login() {
        String url = ConfigReader.getProperty("payervisitbookingurl");
        System.out.println("🚀 Started: Valid Credentials Login Test");
        getDriver().get(url);
        LoginPage loginPage = new LoginPage(getDriver());
        loginPage.enterUsername(ConfigReader.getProperty("ElNasrDoctorUser"));
        loginPage.enterPassword(ConfigReader.getProperty("elnasrdoctorpassword"));
